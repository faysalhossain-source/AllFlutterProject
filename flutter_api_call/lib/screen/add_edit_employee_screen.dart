...
class _AddEditOnlineEmployeeScreenState extends State<AddEditOnlineEmployeeScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (_image != null) {
          ...
          final updateEmployee = OnlineEmployee(
            id: savedEmployee.id,
          ...
          await _apiService.updateEmployee(savedEmployee.id!,updateEmployee);
  ...
  @override
  Widget build(BuildContext context) { // Capital W
    return Scaffold(
      appBar: AppBar(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) =>
                  value!.isEmpty ? 'Enter a designation' : null,
                ),
                TextFormField(
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) return 'Enter date of birth';
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  validator: (value){
                    if(value!.isEmpty) return 'Enter a bSalary ';
                    if(double.tryParse(value)==null){
                      return 'Enter a valid nu,number';
                    }
                    return null;
                  },
                ),
